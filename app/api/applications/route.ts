...
const FIELD_LABELS: Record<string, string> = {
  ...
  intl_cert_type: "International Certificate Type",
  sat_score: "SAT Score",
  sat_id: "SAT ID",
  sat_pdf_path: "SAT Certificate PDF",
  sat_email: "SAT College Board Email",
  sat_password: "SAT College Board Password",
  ib_score: "IB Score",
  ib_id: "IB ID",
  ib_pdf_path: "IB Certificate PDF",
  alevel_score: "A-Levels Score",
  alevel_id: "A-Levels ID",
  alevel_pdf_path: "A-Levels Certificate PDF",
...
export async function PUT(req: NextRequest) {
  try {
    ...
    const allowedFields = [
      ...
      "alevel_verified", "alevel_invalid",
