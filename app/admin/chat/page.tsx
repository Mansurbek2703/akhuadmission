...
export default function AdminChatPage() {
  ...
  // Navigate to the applicant's full profile (detail view on the admissions page)
  ...
  const filtered = applications
    ...
    // Most recent conversation first: sort by last message time, falling back
    // to the application's updated_at when there are no messages yet.
    .sort((a, b) => {
